...
- **UnnnicMultiSelect**: Infinite scroll support with `infiniteScroll`, `infiniteScrollDistance`, and `infiniteScrollCanLoadMore` props, `scroll-end` event, and exposed `finishInfiniteScroll()` / `resetInfiniteScroll()` methods.
