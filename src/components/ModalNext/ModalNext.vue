<template>
  <div
    :class="[
      'unnnic-modal', `type-${type}`,
      {
        'show-close-button': showCloseButton,
        'show-actions-area': validate || actionPrimaryLabel || actionSecondaryLabel
      }
    ]"
  ...
  >
    <div class="container">
      <template v-if="type === 'default'">
        <div v-if="showCloseButton" class="header">
          <unnnic-icon
            icon="close-1"
            size="sm"
            clickable
      ...
      <div v-else-if="type === 'video'" class="content">
      ...
      <template v-else-if="type === 'alert'">
        <div v-if="showCloseButton" class="header">
          <unnnic-icon icon="close-1" size="sm" clickable @click="$emit('close')" />
        </div>
        ...
        <div :class="['content', { 'with-validation': validate }]">
          ...
          <div v-if="validate" class="confirm-text">
            <unnnic-input
              :placeholder="validatePlaceholder"
              v-model="confirmText"
            >
              <span slot="label" v-html="validateLabel" />
            </unnnic-input>
          </div>

          <div
            v-if="validate || actionPrimaryLabel || actionSecondaryLabel" class="actions"
...
import UnnnicInput from '../InputNext/InputNext.vue';
