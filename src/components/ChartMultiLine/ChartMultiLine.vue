...
export default {
  ...
  .unnnic-font {
    ...
    $font-sizes: "body-sm" $unnnic-font-size-body-sm,
      "body-md" $unnnic-font-size-body-md, "body-gt" $unnnic-font-size-body-gt,
      "body-lg" $unnnic-font-size-body-lg, "title-sm" $unnnic-font-size-title-sm,
      "title-md" $unnnic-font-size-title-md, "title-lg" $unnnic-font-size-title-lg,
      "h4" $unnnic-font-size-h4, "h3" $unnnic-font-size-h3,
      "h2" $unnnic-font-size-h2, "h1" $unnnic-font-size-h1;

    $font-weights: "black" $unnnic-font-weight-black,
      "bold" $unnnic-font-weight-bold, "light" $unnnic-font-weight-light;
